...
const serviceCache = new ServiceCache("szmsz");
...
export const getSzakkepzesiMunkaszerzodesAranya = withPerformanceMonitoring(
  async function getSzakkepzesiMunkaszerzodesAranya(alapadatokId, tanev) {
...
export const createSzakkepzesiMunkaszerzodesAranya = withPerformanceMonitoring(
  async function createSzakkepzesiMunkaszerzodesAranya(
    alapadatok_id,
    szakiranyNev,
    szakmaNev,
...
export const updateSzakkepzesiMunkaszerzodesAranya = withPerformanceMonitoring(
  async function updateSzakkepzesiMunkaszerzodesAranya(
    id,
    alapadatok_id,
    szakiranyNev,
    szakmaNev,
...
export const deleteSzakkepzesiMunkaszerzodesAranya = withPerformanceMonitoring(
  async function deleteSzakkepzesiMunkaszerzodesAranya(id) {
